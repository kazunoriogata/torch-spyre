...
try:
    ...
    print("ERROR: Failed to load libaiuminotor.so. Check if ibm-aiu-monitor RPM is installed and/or LD_LIBRARY_PATH is set correctly.",
          file=sys.stderr)
    raise RuntimeError('Missing libaiumonitor.so to handle metrics file in the old format') from e
